...
<div id="drawer-example" className="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
   ...
   <div className="grid grid-cols-2 gap-4">
     ...
     <section className="max-w-6xl mx-auto ">
      ...
      <div className="grid grid-cols-1 gap-y-10 gap-x-32 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-6">
